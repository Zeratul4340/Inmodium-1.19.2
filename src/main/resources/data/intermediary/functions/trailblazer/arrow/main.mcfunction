...
execute if entity @s[scores={in.timer=2..60,tr.ch=75..},predicate=incendium:random/other/x] run summon small_fireball ~ ~ ~ {Tags:["in.checked"],Motion:[0.0d,1.0d,0.0d],power:[0.0d,-0.1d,0.0d]}
